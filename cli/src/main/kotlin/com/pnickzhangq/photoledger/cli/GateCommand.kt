...
fun runGate(
    ...
    // ---- 标注表 ----
    data class Annotation(val file: String, val date: String, val amount: Double, val merchant: String?, val category: String?)
    ...
    println("数据集：${annotations.size} 张（标注 ${csv.name}）")
